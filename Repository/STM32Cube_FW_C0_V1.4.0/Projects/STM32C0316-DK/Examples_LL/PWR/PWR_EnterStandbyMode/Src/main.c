...
/**
  ...
  *          a wakeup pin or external reset through the STM32C0xx PWR LL API.
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  LED_Blinking_5s(LED_BLINK_FAST);
...
/* USER CODE BEGIN 4 */
/**
  * @brief  Set LED1 to Blinking mode during 5s (toggle period based on value provided as input parameter).
...
void EnterStandbyMode(void)
{
  ...
  LL_PWR_SetWakeUpPinPolarityHigh(LL_PWR_WAKEUP_PIN1);
  ...
  /** Request to enter Standby mode
    * Following procedure describe in STM32C0xx Reference Manual
