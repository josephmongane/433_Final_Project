...
/**
  ******************************************************************************
  * @file    I2C/I2C_TwoBoards_MultiMasterIT_Slave/Src/stm32c0xx_it.c
...
void I2C1_IRQHandler(void)
{
  ...
  if(LL_I2C_IsActiveFlag_ADDR(I2C1))
  {
    ...
    if(LL_I2C_GetAddressMatchCode(I2C1) == I2C_ADDRESS)
    {
      /* Verify the transfer direction, a read direction, Slave enters receiver mode */
