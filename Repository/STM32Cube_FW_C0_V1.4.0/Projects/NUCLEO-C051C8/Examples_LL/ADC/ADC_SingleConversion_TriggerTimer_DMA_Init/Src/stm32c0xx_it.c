...
/**
  ******************************************************************************
  * @file    Examples_LL/ADC/ADC_SingleConversion_TriggerTimer_DMA_Init/Src/stm32c0xx_it.c
...
/* Check whether DMA transfer complete caused the DMA interruption */
  ...
  /* USER CODE END DMA1_Channel1_IRQHandler 0 */
  ...
  /* USER CODE END DMA1_Channel1_IRQHandler 1 */
}
