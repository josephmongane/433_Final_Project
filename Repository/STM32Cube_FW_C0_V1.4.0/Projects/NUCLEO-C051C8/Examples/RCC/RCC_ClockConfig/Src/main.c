...
/**
  * @brief  Switch from HSI to HSE , and select it as SYSCLK
  *         source.
...
static void SystemClockHSE_Config(void)
{
 ...
 /* -3- Optional: Disable LSI  Oscillator (if the LSI  is no more needed by the application) */
  RCC_OscInitStruct.OscillatorType                = RCC_OSCILLATORTYPE_HSI;
...
/**
  * @brief  Switch from HSE to HSI , and select it as SYSCLK
  *         source.
  *         The system Clock is configured as follows :
