...
/**
  ...
  *          through the STM32C0xx USART LL API.
...
static void MX_SPI1_Init(void)
{
  ...
  */
  ...
  /* SPI1_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_CHANNEL_5, LL_DMAMUX_REQ_SPI1_RX);
  ...
  LL_DMA_SetDataLength(DMA1, LL_DMA_CHANNEL_4, ubSPI1NbDataToTransmit);
  ...
  LL_DMA_SetDataLength(DMA1, LL_DMA_CHANNEL_5, ubSPI1NbDataToReceive);
...
static void MX_USART1_Init(void)
{
  ...
  */
  ...
  LL_DMA_SetDataLength(DMA1, LL_DMA_CHANNEL_2, ubUSART1NbDataToTransmit);
  LL_DMA_ConfigAddresses(DMA1, LL_DMA_CHANNEL_3,
                         LL_USART_DMA_GetRegAddr(USART1, LL_USART_DMA_REG_DATA_RECEIVE),
                         (uint32_t)aUSART1RxBuffer,
                         LL_DMA_GetDataTransferDirection(DMA1, LL_DMA_CHANNEL_3));
  LL_DMA_SetDataLength(DMA1, LL_DMA_CHANNEL_3, ubUSART1NbDataToReceive);
...
static void MX_DMA_Init(void)
{
  ...
  NVIC_SetPriority(DMAMUX1_DMA1_CH4_5_IRQn, 0);
  NVIC_EnableIRQ(DMAMUX1_DMA1_CH4_5_IRQn);
